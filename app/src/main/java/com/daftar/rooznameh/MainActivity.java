...
public class MainActivity extends Activity {
    ...
    private void syncTodaySms() {
        // SmsReceiver فقط پیامک‌های دارای «مانده» را اسکن و ارسال می‌کند.
        SmsReceiver.retryPendingSms(
    ...
    protected void onResume() {
        ...
        // هر بار برنامه باز یا دوباره فعال شد،
        // پیامک‌های بانکی امروز بررسی می‌شوند.
        syncTodaySms();
    }
